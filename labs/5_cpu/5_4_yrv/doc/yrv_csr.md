| CSR           | Read Only | Writable | Value in YRV      | Reset in hardware? | Init in software? | Updated on backround?  | Comment                                                                                                       |
| ------------- | --------- |--------- | ---------         | --------------- | ------------ | ------------ | ------------------------------------------------------------------------------------------------------------- |
...
| TIME          | Read Only |          | Read Only         | Current time    |              |  Yes         |                                                                                                               |
| TIMEH         | Read Only |          | Read Only         | Current time    |              |  Yes         |                                                                                                               |
