...
#   - mstatus.MPP  [Bits 11:12] : Previous Privilege Mode (saved here on trap)
#
...
# Load the memory boundaries generated by the linker script
    la      t0, __start_bss_zero   # Start address of memory to clear (from .sbss section)
    la      t1, __stop_bss_zero    # End address of memory to clear (from .bss section)
