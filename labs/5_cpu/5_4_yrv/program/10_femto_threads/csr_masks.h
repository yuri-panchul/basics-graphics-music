...
#define MCAUSE_EXCCODE_MASK    MASK_FROM_HI_LO_BIT  ( MCAUSE_EXCCODE_BIT_HI , MCAUSE_EXCCODE_BIT_LO )
#define MCAUSE_INTERRUPT       MASK_FROM_BIT        ( MCAUSE_INTERRUPT_BIT                          )

#define MTVEC_MODE_MASK        MASK_FROM_HI_LO_BIT  ( MTVEC_MODE_BIT_HI     , MTVEC_MODE_BIT_LO     )
#define MTVEC_BASE_MASK        MASK_FROM_HI_LO_BIT  ( MTVEC_BASE_BIT_HI     , MTVEC_BASE_BIT_LO     )

//----------------------------------------------------------------------------

#define MCAUSE_EXCCODE_MACHINE_TIMER_INTERRUPT          7
#define MCAUSE_EXCCODE_MACHINE_EXTERNAL_INTERRUPT       11

#define MCAUSE_EXCCODE_PLATFORM_INTERRUPT_BASE          16

#define MCAUSE_EXCCODE_YRV_PLATFORM_LOCAL_INTERRUPT_0   (MCAUSE_EXCCODE_PLATFORM_INTERRUPT_BASE + 16 +  0)
#define MCAUSE_EXCCODE_YRV_PLATFORM_LOCAL_INTERRUPT_1   (MCAUSE_EXCCODE_PLATFORM_INTERRUPT_BASE + 16 +  1)
#define MCAUSE_EXCCODE_YRV_PLATFORM_LOCAL_INTERRUPT_2   (MCAUSE_EXCCODE_PLATFORM_INTERRUPT_BASE + 16 +  2)
#define MCAUSE_EXCCODE_YRV_PLATFORM_LOCAL_INTERRUPT_3   (MCAUSE_EXCCODE_PLATFORM_INTERRUPT_BASE + 16 +  3)
#define MCAUSE_EXCCODE_YRV_PLATFORM_LOCAL_INTERRUPT_4   (MCAUSE_EXCCODE_PLATFORM_INTERRUPT_BASE + 16 +  4)
#define MCAUSE_EXCCODE_YRV_PLATFORM_LOCAL_INTERRUPT_5   (MCAUSE_EXCCODE_PLATFORM_INTERRUPT_BASE + 16 +  5)
#define MCAUSE_EXCCODE_YRV_PLATFORM_LOCAL_INTERRUPT_6   (MCAUSE_EXCCODE_PLATFORM_INTERRUPT_BASE + 16 +  6)
#define MCAUSE_EXCCODE_YRV_PLATFORM_LOCAL_INTERRUPT_7   (MCAUSE_EXCCODE_PLATFORM_INTERRUPT_BASE + 16 +  7)
#define MCAUSE_EXCCODE_YRV_PLATFORM_LOCAL_INTERRUPT_8   (MCAUSE_EXCCODE_PLATFORM_INTERRUPT_BASE + 16 +  8)
#define MCAUSE_EXCCODE_YRV_PLATFORM_LOCAL_INTERRUPT_9   (MCAUSE_EXCCODE_PLATFORM_INTERRUPT_BASE + 16 +  9)
#define MCAUSE_EXCCODE_YRV_PLATFORM_LOCAL_INTERRUPT_10  (MCAUSE_EXCCODE_PLATFORM_INTERRUPT_BASE + 16 + 10)
#define MCAUSE_EXCCODE_YRV_PLATFORM_LOCAL_INTERRUPT_11  (MCAUSE_EXCCODE_PLATFORM_INTERRUPT_BASE + 16 + 11)
#define MCAUSE_EXCCODE_YRV_PLATFORM_LOCAL_INTERRUPT_12  (MCAUSE_EXCCODE_PLATFORM_INTERRUPT_BASE + 16 + 12)
#define MCAUSE_EXCCODE_YRV_PLATFORM_LOCAL_INTERRUPT_13  (MCAUSE_EXCCODE_PLATFORM_INTERRUPT_BASE + 16 + 13)
#define MCAUSE_EXCCODE_YRV_PLATFORM_LOCAL_INTERRUPT_14  (MCAUSE_EXCCODE_PLATFORM_INTERRUPT_BASE + 16 + 14)
#define MCAUSE_EXCCODE_YRV_PLATFORM_LOCAL_INTERRUPT_15  (MCAUSE_EXCCODE_PLATFORM_INTERRUPT_BASE + 16 + 15)

#define MCAUSE_EXCCODE_APS_PLATFORM_LOCAL_INTERRUPT_8   (1 << (MCAUSE_EXCCODE_PLATFORM_INTERRUPT_BASE + 8))

#endif  // ifndef CSR_MASKS_H
