...
//`define MEM_BASE 16'h8000                                   /* msword of psram mem address */
...
wire  [9:0] byte_cnt_res;
    ...
    assign led[7] = uart_led;
    assign led[1] = sd_status[0];
    assign led[2] = sd_status[1];
    assign led[3] = sd_status[2];
    assign led[4] = sd_status[3];
    assign led[5] = sd_status[4];
    assign led[6] = sd_ready;
  ...
  wire [22:0] current_addr_sector_res;
  wire byte_available_res;
