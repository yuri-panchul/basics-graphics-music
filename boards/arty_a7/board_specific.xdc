...
set_property -dict { PACKAGE_PIN E15   IOSTANDARD LVCMOS33 } [get_ports { JB[0] }]; #IO_L11P_T1_SRCC_15 Sch=jb_p[1] #VGA_B[0] -
...
set_property -dict { PACKAGE_PIN C15   IOSTANDARD LVCMOS33 } [get_ports { JB[3] }]; #IO_L12N_T1_MRCC_15 Sch=jb_n[2] #-VGA_B[3]
set_property -dict { PACKAGE_PIN J17   IOSTANDARD LVCMOS33 } [get_ports { JB[4] }]; #IO_L23P_T3_FOE_B_15 Sch=jb_p[3] #VGA_R[0] -
...
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { JB[7] }]; #IO_L24N_T3_RS0_15 Sch=jb_n[4]  #-VGA_R[3]

##Pmod Header JC

set_property -dict { PACKAGE_PIN U12   IOSTANDARD LVCMOS33 } [get_ports { JC[0] }]; #IO_L20P_T3_A08_D24_14 Sch=jc_p[1] #VGA_HS
set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports { JC[1] }]; #IO_L20N_T3_A07_D23_14 Sch=jc_n[1] #VGA_VS
...
set_property -dict { PACKAGE_PIN U14   IOSTANDARD LVCMOS33 } [get_ports { JC[4] }]; #IO_L22P_T3_A05_D21_14 Sch=jc_p[3] #VGA_G[0] -
...
set_property -dict { PACKAGE_PIN U13   IOSTANDARD LVCMOS33 } [get_ports { JC[7] }]; #IO_L23N_T3_A02_D18_14 Sch=jc_n[4] #-VGA_G[3]
